    ...
    <>
      <section className="bg-[#02334E] text-white py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <FadeUp delay={0.35}>
            <p className="text-white/70 text-lg leading-relaxed max-w-2xl mx-auto">Comprehensive legal services across six core practice areas, delivered by specialists with deep domain expertise.</p>
          </FadeUp>
        </div>
      </section>
          ...
          {areas.map((area, i) => {
            ...
            const Content = (
              <div>
                ...
                <motion.div whileHover={{ x: 4 }} transition={{ duration: 0.2 }}>
                  <Link href={`/practice-areas/${area.slug}`} className="inline-flex items-center gap-2 text-[#C8A065] font-semibold text-sm">
            ...
            const Services = (
              <motion.div
                ...
                whileHover={{ backgroundColor: "#02334E0a" }}
