...
export default function AboutPage() {
  return (
    <>
      <section className="bg-[#0F172A] text-white py-24 px-6 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center">
          <FadeUp delay={0.1}>
            <p className="text-[#3B82F6] text-xs font-semibold uppercase tracking-widest mb-3">About Us</p>
          </FadeUp>
          <FadeUp delay={0.2}>
          ...
          <SlideInLeft>
            <div className="bg-[#F8FAFC] rounded-2xl aspect-square flex items-center justify-center border border-gray-100">
              <div className="text-center p-8">
                <motion.div
                  className="w-32 h-32 rounded-full bg-[#3B82F6]/10 border-2 border-[#3B82F6]/20 mx-auto mb-4 flex items-center justify-center"
                  whileHover={{ scale: 1.05, backgroundColor: "rgba(59,130,246,0.2)" }}
                  transition={{ duration: 0.3 }}
                >
                  <span className="text-[#3B82F6] text-4xl font-black">IL</span>
                </motion.div>
                <p className="font-bold text-[#0F172A] text-lg">Founder & Managing Partner</p>
                <p className="text-gray-400 text-sm">Invictus Law Practice</p>
              </div>
            </div>
          </SlideInLeft>
          <SlideInRight>
            <p className="text-[#3B82F6] text-xs font-semibold uppercase tracking-widest mb-3">Our Founder</p>
            <h2 className="text-3xl font-black text-[#0F172A] mb-4">A Vision for Justice</h2>
            <DrawLine className="w-12 mb-6" />
            <p className="text-gray-500 leading-relaxed mb-4">The founding of Invictus Law Practice was driven by a singular conviction: that every individual and business deserves access to the highest calibre of legal expertise.</p>
            <p className="text-gray-500 leading-relaxed mb-4">With over 15 years of practice spanning corporate transactions, high-stakes litigation, and regulatory compliance, our founder built Invictus on the pillars of integrity, strategic thinking, and an unrelenting drive to achieve results.</p>
            <p className="text-gray-500 leading-relaxed mb-6">The firm&apos;s name — derived from the Latin word for &ldquo;unconquered&rdquo; — reflects our commitment to standing firm for every client, in every matter.</p>
            <motion.div whileHover={{ x: 4 }} transition={{ duration: 0.2 }}>
              <Link href="/contact" className="inline-flex items-center gap-2 text-[#3B82F6] font-semibold text-sm hover:text-[#2563EB] transition-colors">
      ...
      <section className="section-padding bg-[#F8FAFC]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <FadeUp>
              <p className="text-[#3B82F6] text-xs font-semibold uppercase tracking-widest mb-2">What Drives Us</p>
              <h2 className="text-3xl md:text-4xl font-black text-[#0F172A]">Our Mission & Values</h2>
            ...
            {values.map((v) => (
              <StaggerItem key={v.title}>
                <motion.div
                  ...
                  whileHover={{ y: -6, boxShadow: "0 16px 32px rgba(59,130,246,0.1)" }}
                  transition={{ duration: 0.25 }}
                >
                  <motion.div
                    className="w-14 h-14 rounded-full bg-[#0F172A] flex items-center justify-center mx-auto mb-4"
                    whileHover={{ rotate: 10, scale: 1.1 }}
                    transition={{ duration: 0.2 }}
                  >
                    <v.icon className="text-[#3B82F6]" size={24} />
                  </motion.div>
      ...
      <section className="section-padding bg-[#0F172A]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            <FadeUp>
              <p className="text-[#3B82F6] text-xs font-semibold uppercase tracking-widest mb-2">Our Journey</p>
          ...
          <div className="relative">
            <motion.div
              className="absolute left-8 top-0 bottom-0 w-px bg-[#3B82F6]/30"
            ...
            <div className="space-y-10">
              {milestones.map((m, i) => (
                ...
                >
                  <motion.div
                    className="relative flex-shrink-0 w-16 h-16 rounded-full bg-[#3B82F6] flex items-center justify-center z-10 shadow-lg shadow-blue-500/25"
