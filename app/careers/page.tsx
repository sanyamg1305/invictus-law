    ...
    <>
      <section className="bg-[#02334E] text-white py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[#FEDDDD] text-xs font-semibold uppercase tracking-widest mb-3">Join Our Team</p>
          <h1 className="text-4xl md:text-5xl font-black mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>Careers at Invictus</h1>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#02334E] text-xs font-semibold uppercase tracking-widest mb-2">Why Invictus</p>
            <h2 className="text-3xl font-black text-[#0A1628]" style={{ fontFamily: "'Playfair Display', serif" }}>Why Join Invictus Law?</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((b) => (
              <div key={b.title} className="text-center">
                <div className="w-14 h-14 rounded-full bg-[#02334E] flex items-center justify-center mx-auto mb-4">
                  <b.icon className="text-[#FEDDDD]" size={24} />
                </div>
      ...
      <section className="section-padding bg-[#F8FAFC]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#02334E] text-xs font-semibold uppercase tracking-widest mb-2">Opportunities</p>
            <h2 className="text-3xl font-black text-[#0A1628]" style={{ fontFamily: "'Playfair Display', serif" }}>Open Positions</h2>
          </div>
          <div className="space-y-4">
            {openRoles.map((role) => (
              <div key={role.title} className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <h3 className="font-bold text-[#0A1628] text-base">{role.title}</h3>
                  <div className="flex flex-wrap gap-3 mt-2">
                    <span className="text-xs px-2.5 py-1 bg-[#02334E]/5 text-[#02334E] rounded-full font-medium">{role.type}</span>
                    <span className="text-xs px-2.5 py-1 bg-[#FEDDDD]/20 text-[#02334E] rounded-full font-medium">{role.location}</span>
                    <span className="text-xs text-[#64748B]">{role.experience}</span>
                  </div>
                </div>
                <Link
                  href="/contact"
                  className="shrink-0 inline-flex items-center gap-2 px-5 py-2.5 bg-[#02334E] text-white text-sm font-semibold rounded-lg hover:bg-[#011E30] transition-colors"
                >
      ...
      <section className="section-padding bg-[#02334E]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#FEDDDD] text-xs font-semibold uppercase tracking-widest mb-2">How to Apply</p>
            <h2 className="text-3xl font-black text-white" style={{ fontFamily: "'Playfair Display', serif" }}>Application Process</h2>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={s.step} className="text-center">
                <div className="w-12 h-12 rounded-full bg-[#FEDDDD] flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#02334E] font-black text-sm">{s.step}</span>
                </div>
      ...
      <section className="section-padding bg-[#02334E]">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-black text-white mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Don&apos;t See the Right Role?</h2>
          <p className="text-white/70 mb-2">We&apos;re always open to talented legal professionals who share our values.</p>
          <p className="text-white/60 text-sm mb-8">Send a general application to <strong>careers@invictuslaw.in</strong></p>
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <div key={v.title} className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-white text-sm font-medium">
