    ...
    <>
      <section className="bg-[#02334E] text-white py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[#C8A065] text-xs font-semibold uppercase tracking-widest mb-3">Join Our Team</p>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-[#02334E]">Why Join Invictus Law?</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((b) => (
              <div key={b.title} className="text-center">
                <div className="w-14 h-14 rounded-full bg-[#02334E] flex items-center justify-center mx-auto mb-4">
                  <b.icon className="text-[#C8A065]" size={24} />
                </div>
                <h3 className="font-bold text-[#02334E] mb-2">{b.title}</h3>
      ...
      <section className="section-padding bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#C8A065] text-xs font-semibold uppercase tracking-widest mb-2">Opportunities</p>
            <h2 className="text-3xl font-black text-[#02334E]">Open Positions</h2>
          </div>
          <div className="space-y-4">
            {openRoles.map((role) => (
              <div key={role.title} className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <h3 className="font-bold text-[#02334E] text-base">{role.title}</h3>
                  <div className="flex flex-wrap gap-3 mt-2">
                    <span className="text-xs px-2.5 py-1 bg-[#02334E]/5 text-[#02334E] rounded-full font-medium">{role.type}</span>
                    <span className="text-xs px-2.5 py-1 bg-[#C8A065]/10 text-[#a8844a] rounded-full font-medium">{role.location}</span>
                    <span className="text-xs text-gray-400">{role.experience}</span>
                  </div>
                </div>
                <Link
                  href="/contact"
                  className="shrink-0 inline-flex items-center gap-2 px-5 py-2.5 bg-[#02334E] text-white text-sm font-semibold rounded hover:bg-[#034568] transition-colors"
                >
      ...
      <section className="section-padding bg-[#02334E]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#C8A065] text-xs font-semibold uppercase tracking-widest mb-2">How to Apply</p>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={s.step} className="text-center">
                <div className="w-12 h-12 rounded-full bg-[#C8A065] flex items-center justify-center mx-auto mb-3">
